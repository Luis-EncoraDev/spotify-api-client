...
import PopoularSongsTable from "./PopularTracksTable";
            ...
            <div className="flex w-auto h-full justify-around items-start">
                <div className="flex flex-col gap-4">
                    ...
                    <div className="flex flex-col mt-6 gap-4 items-center">
                        <p className="font-bold text-[4rem]">{artist?.name}</p>
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <PopoularSongsTable popularTracks={popularTracks ? popularTracks : []} />
                </div>
            </div>
